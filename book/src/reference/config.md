...
Specifies whether dist [should distribute (build and publish) a package][distribute], overidding all other rules for deciding if a package is eligible.
